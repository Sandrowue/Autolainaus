...
with open('asetukset.json', 'rt') as readJsonAsetukset:
    readFileContent6 = readJsonAsetukset.read()
    readFileContent7 = json.loads(readFileContent6)

print(readFileContent7)
